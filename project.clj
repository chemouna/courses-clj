(defproject courses-clj "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "courses-clj.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main courses-clj.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "courses-clj.core/on-figwheel-reload"}

                :compiler {:main courses-clj.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/courses_clj.js"
